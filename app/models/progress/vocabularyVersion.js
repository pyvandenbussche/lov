...
var VocabularySchema = new Schema({
  ...
  vocabulary: { type : Schema.ObjectId, ref : 'Vocabulary' },
  classNumber: {type : Number, default : 0},
  propertyNumber: {type : Number, default : 0},
  datatypeNumber: {type : Number, default : 0},
  instanceNumber: {type : Number, default : 0},
  languages: {type: [], get: getLanguages, set: setLanguages},
  voafRelations: [{
    type: {type : String, default : '', trim : true},
    cardinality: {type : Number, default : 0},
    vocabulary: {type : String, default : '', trim : true},
  }],
  ...
  terms: [{
    term: { type : Schema.ObjectId, ref : 'TermVersion' },
    uri: {type : String, default : '', trim : true},
